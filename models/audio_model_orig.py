...
class cnn_audio(nn.Module):
	...
	def __init__(self):
		...
		self.pool1 = nn.MaxPool2d(kernel_size=[4, 2], stride=[4, 2], padding=0, dilation=1, ceil_mode=False)
		...
		self.avg_pool = nn.AvgPool2d(kernel_size=[13, 2],  # [2,7,7] [13, 2]
							   stride=[1, 1])
