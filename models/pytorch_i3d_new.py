...
class InceptionI3d(nn.Module):
	...
	def __init__(self, num_classes=400, spatial_squeeze=True,
		...
		self.end_points[end_point] = MaxPool3dSamePadding(kernel_size=[1, 3, 3], stride=(1, 2, 2), # stride=(1, 2, 2),
															 padding=0)
		if self._final_endpoint == end_point: return
		...
		self.end_points[end_point] = MaxPool3dSamePadding(kernel_size=[1, 3, 3], stride=(1, 2, 2), # kernel_size=[1, 3, 3], stride=(1, 2, 2),
															 padding=0)
		if self._final_endpoint == end_point: return
		...
		end_point = 'Logits'
		self.avg_pool = nn.AvgPool3d(kernel_size=[1, 7, 7], # kernel_size=[2, 7, 7],
									 stride=(1, 1, 1))
